...
describe('mapStateToProps for DetailedNewsArticles container component', () => {
    const fakeState = {
...
describe('mapDispatchToProps for DetailedNewsArticles container component', () => {
    ...
    it(`should return object with function loadNews that should dispatch LOAD_NEWS action with passed url and  ${
        ...
        expect(dispatch).toBeCalledWith({
            ...
            payload: {
                apiLink: testApiUrl,
                uploadedActionType: actionTypes.TOP_NEWS_DOWNLOADED,
            },
        });
    });
});
